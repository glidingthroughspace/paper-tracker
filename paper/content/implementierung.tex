...
Innerhalb der App für den Paper-Tracker gibt es ein fehlende Funktion, die noch nicht implementiert wurde.
...
Konkret müsste auf der \enquote{WorkflowTemplatePage} und den dazugehörigen Widgets alle Auswahllisten für einen Raum durch
eine Mehrfachauswahl ersetzt werden.
Weiter müsste das Widget für die Darstellung von Steps eines Templates angepasst werden, mehrere Räume anzuzeigen.

Zusätzlich neben dieser fehlenden Funktionalität, gibt es einige kleinere \gls{UI}-Änderungen.
Zum einen muss das Farbschema der App überarbeitet werden.
Laut \TODO{Hier Quelle} besitzt die verwendete Farbkombination aus Grau und Lila einen sehr schlechten Kontrast.
...
\subsection{Messung des Batteriestand}
\TODO{}