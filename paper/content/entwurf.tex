...
Der erste Teil ist das Einscannen eines Raumes mit Hilfe eines Trackers und der zweite das zuordnen von Scanergebnisse
...
Nach den Scans liegen für alle verfügbaren \gls{BSSID}s ein oder mehrere \gls{RSSI} (also Signalstärken) vor.
Weiter gehört jede \gls{BSSID} zu einer \gls{SSID}.

Diese Daten sollen im nächsten Schritt von dem Benutzer nach \gls{SSID}s gefiltert werden, die für die Lokalisierung
