...
Dies ergibt sich der Vorteil, dass sie mit allen anderen gewählten Technologien sehr gut
...
\textbf{Verb} & \textbf{Pfad}                        & \textbf{Aktion}                     & \textbf{Parameter}                                          & \textbf{Rückgabe-Wert}                                                   \hline \endfirsthead
\textbf{Verb} & \textbf{Pfad}                        & \textbf{Aktion}                     & \textbf{Parameter}                                          & \textbf{Rückgabe-Wert}                                                   \hline \endhead
...
GET           & /tracker                             & Auflistung der Tracker              & -                                                           & Liste aller Tracker                                                      \\ \hline
...
GET           & /tracker/:id/learn                   & Lernstatus abfragen                & -                                                           & \begin{tabular}[c]{@{}l@{}}Abgeschlossen\\ Gefundene SSIDs\end{tabular} \\ \hline
...
POST          & /workflow/template/:id/step/:id/move & Schritt verschieben                 & Richtung                                                    & -                                                                       \\ \hline
