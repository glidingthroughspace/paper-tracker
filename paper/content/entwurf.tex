...
Allgemein ist die Hauptseite in verschiedene Tabs aufgeteilt, die jeweils für eine Klasse im Datenmodell stehen.
...
Jeder Tab beinhaltet eine Liste aller Objekte der entsprechenden Klasse mit den wichtigsten dazugehörigen Informationen.
...
\FloatBarrier
\subsubsection{Dialoge zum Erstellen und Bearbeiten von Objekten} \label{sec:app-dialog}

\FloatBarrier
\subsubsection{Tutorial-Seite}
