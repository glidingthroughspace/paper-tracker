...
void main() {
  ...
  const trackerOrig = '{ "id": 2, "label": "Test Tracker", "last_poll": "1970-01-01T00:00:00.000Z", "last_sleep_time": "1970-01-01T00:00:00.000Z", "status": 1 }';
  ...
  test('Test tracker serialization', () async {
    var tracker = Tracker(id: 2, label: "Test Tracker", lastPoll: zeroTime, lastSleepTime: zeroTime, status: TrackerStatus.Idle);
